...
void diServiceSwVerInit( void )
{
    ...
    gecko_cmd_gatt_server_write_attribute_value( gattdb_software_revision_string, 0, strlen( software_version ),
...
void diServiceFwVerInit( struct gecko_msg_system_boot_evt_t *evt_system_boot )
{
    ...
    gecko_cmd_gatt_server_write_attribute_value( gattdb_firmware_revision_string, 0, VER_CHARACTERISTIC_SIZE,
